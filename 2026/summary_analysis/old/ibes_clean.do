...
* Shrinkage specs
*=============================*
local shrink_specs STDEV_6to11_vs_0to5 STDEV_6to11_vs_0 STDEV_5_vs_0 Mean_log_STDEV_change CV_10_vs_0 CV_5_vs_0
*=============================*
* Safe log helper
*=============================*
...
foreach shrink_spec of local shrink_specs {
    ...
    *=============================*
egen FE_MEAN_all = rowmean(FE_MEAN0-FE_MEAN11)
egen FE_MEDIAN_all = rowmean(FE_MEDIAN0-FE_MEDIAN11)
