...
twoway (connected ACTUAL sym, yaxis(1) msize(vsmall) msymbol(square) lpattern(solid)) ///
	   ...
	   xlabel(660(12)729, valuelabel angle(90) labsize(*0.7)) name(alcoa_example_1, replace)	   
...
twoway (connected FE_log sym, yaxis(1) msize(small) msymbol(lgx) lpattern(solid)) ///
	   ...
	   ) xlabel(660(12)729, valuelabel angle(90) labsize(*0.7)) name(alcoa_example_2, replace)	   
